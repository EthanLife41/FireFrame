...
- The Fire tablet does not need to log into iCloud or Google Photos.
- In the future, you can write a local Mac script to automatically export a curated album into this folder.
